...
project = 'Pokémon Analyzer'
copyright = '2025, PokéOCR'
author = 'PokéOCR Team'
release = '1.0.0'
...
extensions = [
    ...
    'sphinx.ext.napoleon',       # Support pour Google Style et NumPy Style docstrings
    ...
    'sphinx_autodoc_typehints',  # Support pour les type hints
]

# Configuration Napoleon pour Google Style docstrings
